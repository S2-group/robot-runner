...
class RunTableModel:
    ...
    def __init__(self, factors: List[ExperimentFactorModel], exclude_variations: List[Dict] = None, data_columns: List[str] = None):
        self.__factors = factors
        self.__experiment_run_table = []
        self.__exclude_variations = exclude_variations
        self.__data_columns = data_columns

    def get_factors(self) -> List[ExperimentFactorModel]:
